...
When the user asks you to call a tool, you must respond with a JSON object containing the keys "tool" and "args".

Available tools:
- output_every_func_return_type: Returns a list of function names and their return types for a given file.
  Args: {"file_path": "string"}

Please call the tool 'output_every_func_return_type' with 'file_path' set to an empty string.
"""
