...
# TODO: Fill this in!
YOUR_SYSTEM_PROMPT = "You are a helpful coding assistant. Use the provided context to write accurate code that follows the documentation exactly."
...
def YOUR_CONTEXT_PROVIDER(corpus: List[str]) -> List[str]:
    """Returns the relevant documents from the corpus for the current task.
    In this case, we return the entire corpus as it contains the necessary API documentation.
    """
    return corpus
